...
const IcedCoffeProductsCard = ({ coffe }) => {
  ...
  const handleDelete = (coffe) => {
    ...
    if (agree) {
      fetch(
        `https://coffe-shop-server-site.vercel.app/iced_coffe/${coffe._id}`,
        {
          method: "delete",
        }
      )
...
export default IcedCoffeProductsCard;
